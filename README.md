# webЯcade Application: Nintendo Entertainment System (NES) Emulator
...
The underlying emulator is a modified version of the Libretro fork of [FCEUmm](https://github.com/libretro/libretro-fceumm).
...
The license presented above is limited to the [webЯcade](https://www.webrcade.com) Nintendo Entertainment System application. The underlying Libretro FCEUmm project retains its own specific licensing.
